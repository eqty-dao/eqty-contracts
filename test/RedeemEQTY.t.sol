...
contract RedeemEQTYTest is Test {
    ...
    function test_receive_acceptsETH() public {
        ...
        vm.deal(alice, 5 ether); // Give alice ETH to send
        vm.prank(alice);
    ...
    function test_availableETH_excludesPendingFees() public {
        ...
        // After redeem, available should be 0 (all ETH sent out, only fees remain)
        assertEq(redeemContract.availableETH(), 0);
        
        // Pending fees should exist
